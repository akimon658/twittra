...
**tags** | [**Vec<models::UserTag>**](UserTag.md) | タグリスト | 
...
**bot** | **bool** | BOTかどうか | 
**state** | [**models::UserAccountState**](UserAccountState.md) |  | 
**permissions** | [**Vec<models::UserPermission>**](UserPermission.md) | 所有している権限の配列 | 
