...
> models::FileInfo get_file_meta(file_id)
ファイルメタを取得
...
> Vec<models::FileInfo> get_files(channel_id, limit, offset, since, until, inclusive, order, mine)
ファイルメタのリストを取得
...
> models::FileInfo post_file(file, channel_id)
ファイルをアップロード
