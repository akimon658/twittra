...
#[utoipa::path(
    ...
    params(
        ...
        ("since" = Option<OffsetDateTime>, Query, description = "Fetch messages created after this timestamp"),
        ("until" = Option<OffsetDateTime>, Query, description = "Fetch messages created before this timestamp"),
